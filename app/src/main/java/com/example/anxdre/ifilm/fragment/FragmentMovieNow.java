...
public class FragmentMovieNow extends Fragment {
    ImageView thumbnail;
    TextView title;
    ...
    private void fan() {
        ...
        movies.clear();
        Log.i("_url", API.NOW_PLAYING);
        AndroidNetworking.get(API.NOW_PLAYING).setPriority(Priority.MEDIUM)
                .build()
